...
import { DiscoverTVResponse, MediaTVDetailsResponse, MediaTVCreditsResponse, MediaTVImagesResponse, MediaTVSeasonResponse, MediaTVVideosResponse, MediaMVDetailsResponse } from './tmdb.models';
